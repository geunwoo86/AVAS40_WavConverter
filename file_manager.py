...
📌 Description:  File management module for AVAS40 Sound Convertor
📌 Author:       Geunwoo Lee
📌 Date:         2025-01-15
📌 Version:      1.00
=========================================================================================
...
📌 Folder Structure:
    Output/
    ├── EngineSound/    (engine sound files)
    └── EventSound/     (event sound files)
